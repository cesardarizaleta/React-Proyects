...
export default function Register() {
    return (
        <div id="register-content" className="flex flex-col h-full -right-1/2 absolute w-1/2 bg-gray-950 p-10 items-center justify-center gap-5 transition-all duration-1000">
            ...
            <button id="btn-change-reg" className="text-black rounded-3xl bg-white w-3/4 p-3">Login</button>
        </div>
    )
}